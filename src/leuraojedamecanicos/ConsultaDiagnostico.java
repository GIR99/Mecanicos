 ...
 * @author Chiiv
 */
public class ConsultaDiagnostico extends javax.swing.JFrame {
        ...
        public void Mostrar(String Placa)
    {
       ...
       DefaultTableModel model=new DefaultTableModel();
        model.addColumn("Numero Diagnostico");
        ...
        model.addColumn("Fecha de Diagnostico");
        Tabla.setModel(model);
        String sql="";
        if(Placa.equals(""))
        {
           sql="select diagnostico.IdDiagnostico,diagnostico.NumeroCliente,cliente.Nombre,cliente.ApellidoP,cliente.ApellidoM,diagnostico.NumeroVehiculo,vehiculos.vehiculo,vehiculos.Placa,diagnostico.FechaDiagnostico from diagnostico,cliente,vehiculos where diagnostico.NumeroCliente=cliente.IdCliente and diagnostico.NumeroVehiculo=Vehiculos.IdVehiculos;"; 
        }else{
    ...
    private void initComponents() {
        ...
        getContentPane().add(EntradaPlaca, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 120, 110, 30));
        ...
        jLabel6.setText("Consulta de ID");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 30, 160, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDiagnostico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaDiagnostico().setVisible(true);
            }
        });
    }
